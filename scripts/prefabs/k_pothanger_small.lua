...
return Prefab("sap_pothanger_potsmall", potfn, assets, prefabs),
MakePlacer("sap_pothanger_potsmall_placer", "quagmire_potsmall_hanger", "quagmire_potsmall_hanger", "idle_loop", false, nil, nil, nil, nil, nil, potplacetestfn)
