...
return Prefab("sap_legacytwiggy_tall", fn, assets, prefabs),
MakePlacer("sap_legacytwiggy_tall_placer", "twiggy_tall_old", "legacy_twiggytree_tall_old", "sway1_loop_tall", false, nil, nil, nil, nil, nil, twiggyplacefn)