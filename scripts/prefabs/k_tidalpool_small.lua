...
return Prefab("sap_tidalpool_small", fn, assets, prefabs),
Prefab("sap_marsh_plant_tropical", plantfn, assets, prefabs),
MakePlacer("sap_tidalpool_small_placer", "tidal_pool", "tidal_pool", "small_idle", true)