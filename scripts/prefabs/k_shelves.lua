...
local function SpawnChildren(inst)
    if not inst.childrenspawned then
        ...
        for i = 1, inst.size do
            local object = SpawnPrefab("sap_shelves_slot")
...
return Prefab("sap_shelves_wood", wood, assets, prefabs),
Prefab("sap_shelves_basic", basic, assets, prefabs),
Prefab("sap_shelves_marble", marble, assets, prefabs),
Prefab("sap_shelves_glass", glass, assets, prefabs),
Prefab("sap_shelves_ladder", ladder, assets, prefabs),
Prefab("sap_shelves_hutch", hutch, assets, prefabs),
Prefab("sap_shelves_industrial", industrial, assets, prefabs),
Prefab("sap_shelves_adjustable", adjustable, assets, prefabs),
Prefab("sap_shelves_fridge", fridge, assets, prefabs), 
Prefab("sap_shelves_cinderblocks", cinderblocks, assets, prefabs),
Prefab("sap_shelves_midcentury", midcentury, assets, prefabs),
Prefab("sap_shelves_wallmount", wallmount, assets, prefabs),
Prefab("sap_shelves_aframe", aframe, assets, prefabs),
Prefab("sap_shelves_crates", crates, assets, prefabs),
Prefab("sap_shelves_metalcrates", metalcrates, assets, prefabs),
Prefab("sap_shelves_pipe", pipe, assets, prefabs),
Prefab("sap_shelves_hattree", hattree, assets, prefabs),
Prefab("sap_shelves_pallet", pallet, assets, prefabs),
Prefab("sap_shelves_floating", floating, assets, prefabs),
Prefab("sap_shelves_displaycase", display, assets, prefabs),
Prefab("sap_shelves_displaycase_metal", display_metal, assets, prefabs),
Prefab("sap_shelves_queen_display_1", queen_display1, assets, prefabs),
Prefab("sap_shelves_queen_display_2", queen_display2, assets, prefabs),
Prefab("sap_shelves_queen_display_3", queen_display3, assets, prefabs),
Prefab("sap_shelves_queen_display_4", queen_display4, assets, prefabs),
Prefab("sap_shelves_ruins", ruins, assets, prefabs),
Prefab("sap_shelves_bank", bank, assets, prefabs),
Prefab("sap_shelves_woodcrate", woodcrate, assets, prefabs),
Prefab("sap_shelves_barrel", barrel, assets, prefabs),
Prefab("sap_shelves_barreldome", barreldome, assets, prefabs),
Prefab("sap_shelves_cablespool", cablespool, assets, prefabs),
Prefab("sap_shelves_cakestand", cakestand, assets, prefabs),
Prefab("sap_shelves_cakestanddome", cakestanddome, assets, prefabs),
Prefab("sap_shelves_cart", cart, assets, prefabs),
Prefab("sap_shelves_fridge2", fridge2, assets, prefabs),
Prefab("sap_shelves_globe", globe, assets, prefabs),
Prefab("sap_shelves_ice", ice, assets, prefabs),
Prefab("sap_shelves_icebucket", icebucket, assets, prefabs),
Prefab("sap_shelves_mahogany", mahogany, assets, prefabs),
Prefab("sap_shelves_marble2", marble2, assets, prefabs),
Prefab("sap_shelves_marblesilk", marblesilk, assets, prefabs),
Prefab("sap_shelves_metal", metal, assets, prefabs),
Prefab("sap_shelves_stoneslab", stoneslab, assets, prefabs),
Prefab("sap_shelves_traystand", traystand, assets, prefabs),
Prefab("sap_shelves_wagon", wagon, assets, prefabs),
Prefab("sap_shelves_yotp", yotp, assets, prefabs),
Prefab("sap_shelves_yotp2", yotp2, assets, prefabs),
Prefab("sap_shelves_lock", lockroyal, assets, prefabs),
MakePlacer("sap_shelves_wood_placer", "bookcase", "room_shelves", "wood"),
MakePlacer("sap_shelves_basic_placer", "bookcase", "room_shelves", "basic"),
MakePlacer("sap_shelves_marble_placer", "bookcase", "room_shelves", "marble"),
MakePlacer("sap_shelves_glass_placer", "bookcase", "room_shelves", "glass"),
MakePlacer("sap_shelves_ladder_placer", "bookcase", "room_shelves", "ladder"),
MakePlacer("sap_shelves_hutch_placer", "bookcase", "room_shelves", "hutch"),
MakePlacer("sap_shelves_industrial_placer", "bookcase", "room_shelves", "industrial"),
MakePlacer("sap_shelves_adjustable_placer", "bookcase", "room_shelves", "adjustable"),
MakePlacer("sap_shelves_wallmount_placer", "bookcase", "room_shelves", "wallmount"),
MakePlacer("sap_shelves_fridge_placer", "bookcase", "room_shelves", "fridge"),
MakePlacer("sap_shelves_floating_placer", "bookcase", "room_shelves", "floating"),
MakePlacer("sap_shelves_cinderblocks_placer", "bookcase", "room_shelves", "cinderblocks", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_midcentury_placer", "bookcase", "room_shelves", "midcentury"),
MakePlacer("sap_shelves_aframe_placer", "bookcase", "room_shelves", "aframe"),
MakePlacer("sap_shelves_crates_placer", "bookcase", "room_shelves", "crates", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_metalcrates_placer", "bookcase", "room_shelves", "metalcrates", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_pipe_placer", "bookcase", "room_shelves", "pipe"),
MakePlacer("sap_shelves_hattree_placer", "bookcase", "room_shelves", "hattree"),
MakePlacer("sap_shelves_pallet_placer", "bookcase", "room_shelves", "pallet"),
MakePlacer("sap_shelves_displaycase_placer", "bookcase", "room_shelves", "displayshelf_wood"),
MakePlacer("sap_shelves_displaycase_metal_placer", "bookcase", "room_shelves", "displayshelf_metal"),
MakePlacer("sap_shelves_ruins_placer", "bookcase", "room_shelves", "ruins"),
MakePlacer("sap_shelves_bank_placer", "pedestal", "pedestal_crate", "bank", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_woodcrate_placer", "pedestal", "pedestal_crate", "idle", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_barrel_placer", "pedestal", "pedestal_crate", "idle_barrel", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_barreldome_placer", "pedestal", "pedestal_crate", "idle_barrel_dome", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_cablespool_placer", "pedestal", "pedestal_crate", "idle_cablespool", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_cakestand_placer", "pedestal", "pedestal_crate", "idle_cakestand", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_cakestanddome_placer", "pedestal", "pedestal_crate", "idle_cakestand_dome", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_cart_placer", "pedestal", "pedestal_crate", "idle_cart", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_fridge2_placer", "pedestal", "pedestal_crate", "idle_fridge_display", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_globe_placer", "pedestal", "pedestal_crate", "idle_globe_bar", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_ice_placer", "pedestal", "pedestal_crate", "idle_ice_box", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_icebucket_placer", "pedestal", "pedestal_crate", "idle_ice_bucket", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_mahogany_placer", "pedestal", "pedestal_crate", "idle_mahoganycase", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_marble2_placer", "pedestal", "pedestal_crate", "idle_marble", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_marblesilk_placer", "pedestal", "pedestal_crate", "idle_marblesilk", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_metal_placer", "pedestal", "pedestal_crate", "idle_metal", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_stoneslab_placer", "pedestal", "pedestal_crate", "idle_stoneslab", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_traystand_placer", "pedestal", "pedestal_crate", "idle_traystand", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_wagon_placer", "pedestal", "pedestal_crate", "idle_wagon", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_yotp_placer", "pedestal", "pedestal_crate", "idle_yotp", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_yotp2_placer", "pedestal", "pedestal_crate", "idle_yotp_2", nil, nil, nil, nil, nil, "two"),
MakePlacer("sap_shelves_lock_placer", "pedestal", "pedestal_crate", "lock1_front", nil, nil, nil, nil, nil, "two")