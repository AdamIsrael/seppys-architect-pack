...
return Prefab("sap_legacytwiggy_diseased_old", fn, assets, prefabs),
MakePlacer("sap_legacytwiggy_diseased_old_placer", "twiggy_diseased_tall_old", "legacy_twiggytree_diseased_tall_old", "idle_old", false, nil, nil, nil, nil, nil, twiggyplacefn)