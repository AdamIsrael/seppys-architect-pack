...
return Prefab("sap_burnttree_short", shortfn, assets, prefabs),
MakePlacer("sap_burnttree_short_placer", "evergreen_short", "evergreen_new", "burnt_short"),
Prefab("sap_burnttree_normal", normalfn, assets, prefabs),
MakePlacer("sap_burnttree_normal_placer", "evergreen_short", "evergreen_new", "burnt_normal"),
Prefab("sap_burnttree_tall", tallfn, assets, prefabs),
MakePlacer("sap_burnttree_tall_placer", "evergreen_short", "evergreen_new", "burnt_tall"),

Prefab("sap_burnttree2_short", short_deciduousfn, assets, prefabs),
MakePlacer("sap_burnttree2_short_placer", "tree_leaf", "tree_leaf_trunk_build", "burnt_short"),
Prefab("sap_burnttree2_normal", normal_deciduousfn, assets, prefabs),
MakePlacer("sap_burnttree2_normal_placer", "tree_leaf", "tree_leaf_trunk_build", "burnt_normal"),
Prefab("sap_burnttree2_tall", tall_deciduousfn, assets, prefabs),
MakePlacer("sap_burnttree2_tall_placer", "tree_leaf", "tree_leaf_trunk_build", "burnt_tall"),

Prefab("sap_burnttree3_short", short_twiggyfn, assets, prefabs),
MakePlacer("sap_burnttree3_short_placer", "twiggy", "twiggy_build", "burnt_short"),
Prefab("sap_burnttree3_normal", normal_twiggyfn, assets, prefabs),
MakePlacer("sap_burnttree3_normal_placer", "twiggy", "twiggy_build", "burnt_normal"),
Prefab("sap_burnttree3_tall", tall_twiggyfn, assets, prefabs),
MakePlacer("sap_burnttree3_tall_placer", "twiggy", "twiggy_build", "burnt_tall"),

Prefab("sap_burnttree4_short", short_moonfn, assets, prefabs),
MakePlacer("sap_burnttree4_short_placer", "moon_tree", "moon_tree", "burnt_short"),
Prefab("sap_burnttree4_normal", normal_moonfn, assets, prefabs),
MakePlacer("sap_burnttree4_normal_placer", "moon_tree", "moon_tree", "burnt_normal"),
Prefab("sap_burnttree4_tall", tall_moonfn, assets, prefabs),
MakePlacer("sap_burnttree4_tall_placer", "moon_tree", "moon_tree", "burnt_tall"),

Prefab("sap_burnttree5", tall_marshfn, assets, prefabs),
MakePlacer("sap_burnttree5_placer", "marsh_tree", "tree_marsh", "burnt_idle")