...
treeset("kyno_mushtree_tall", tree_data.tall, "anim/mushroom_tree_tall.zip", "anim/mushroom_tree_tall_bloom.zip")
treeset("kyno_mushtree_medium", tree_data.medium, "anim/mushroom_tree_med.zip", "anim/mushroom_tree_med_bloom.zip")
treeset("kyno_mushtree_small", tree_data.small, "anim/mushroom_tree_small.zip", "anim/mushroom_tree_small_bloom.zip")
