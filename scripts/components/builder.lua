...
function Builder:MakeRecipeAtPoint(recipe, pt, rot, skin)
	...
	if recipe.product == "sap_wreck_1" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_wreck_2" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_wreck_3" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_wreck_4" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_seaweed" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_brain_rock" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_rock_coral_1" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_rock_coral_2" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_rock_coral_3" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_redbarrel" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_bermudatriangle" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_ballphinhouse" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_octopusking" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_luggagechest" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_fishinhole" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_buoy" 					and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_sea_chiminea" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_seayard" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_extractor" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_musselfarm" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_fishfarm" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_sealab" 					and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_krakenchest" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_waterchest" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_watercrate" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_tarpit" 					and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_seastack" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_saltstack" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_wobster_den" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_moon_wobster_den" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_sea_grass" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_sea_reeds" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_volcano" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_lilypad" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_lotusplant" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_whalebubbles" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_whale_blue" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_whale_white" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_jellyfish" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_jellyfish_rainbow" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_kraken" 					and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_kraken_tentacle" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_wilbur_sleeping" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_bioluminescence" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_knightboat" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_bishopboat" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_rookboat" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_seataro_planted" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_slow_hydrofarmplot" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_fast_hydrofarmplot" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_slow_hydrofarmmeat" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_fast_hydrofarmmeat" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_watercress_planted" 		and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_whirlpool" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_sea_cocoon" 				and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_sea_cocoon_1" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_sea_cocoon_2" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_sea_cocoon_3" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_watertree_root" 			and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
	if recipe.product == "sap_seastrider_nest_water"	and recipe.placer ~= nil and self:IsBuildBuffered(recipe.name) then self:MakeRecipe(recipe, pt, rot, skin) end
